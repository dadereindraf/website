                        ...
                        <div class="col">
                            <div class="uploadFile">
                                ...
                                if (isset($_POST["truncate"])) {
                                    $sql_truncate = "TRUNCATE TABLE dataraw";
                                    ...
                                    if ($uploadOk == 0) {
                                        ...
                                        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                                            ...
                                            while (($data = fgetcsv($file, 1000, ",")) !== FALSE) {
                                                ...
                                                $username = $data[0]; // Kolom username

                                                // Ganti kutipan tunggal dengan dua kutipan tunggal dalam nilai teks
                                                $text = str_replace("'", "''", $data[1]); // Kolom text

                                                $label = $data[2]; // Kolom label

                                                // Lakukan operasi INSERT SQL ke dalam tabel database
                                                $sql = "INSERT INTO dataraw (username, text, label) VALUES ('$username', '$text', '$label')";
